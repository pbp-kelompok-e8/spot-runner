...
urlpatterns = [
    ...
    path('edit-flutter/<str:review_id>/', views.edit_review_flutter, name='edit_review_flutter'),
    path('delete-flutter/<str:review_id>/', views.delete_review_flutter, name='delete_review_flutter'),
]