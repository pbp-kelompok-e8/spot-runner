...
from apps.main.views import register, show_main, login_user, show_user, logout_user, edit_profile_runner, cancel_event, participate_in_event, change_password, delete_profile, show_all_users_json, show_user_json
...
urlpatterns = [
    ...
    path('user/<str:username>/json', show_user_json, name='show_user_json'),
