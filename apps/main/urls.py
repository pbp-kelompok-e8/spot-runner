...
from apps.main.views import register, show_main, login_user, show_user, logout_user, events_attended, edit_profile_runner
...
urlpatterns = [
    ...
    path('events-attended/', events_attended, name='events_attended'),
